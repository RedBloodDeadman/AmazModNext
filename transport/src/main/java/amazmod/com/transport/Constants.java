...
public class Constants {
    ...
    public static final String PREF_NOTIFICATIONS_VIBRATION_AMOUNT = "preference.amazmodservice.vibration.amount";
    ...
    public static final String PREF_DEFAULT_NOTIFICATIONS_VIBRATION_AMOUNT = "2";
